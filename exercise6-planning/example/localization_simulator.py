...
class Simulator(object):
	...
	self.chassis = Chassis()
        self.node.create_reader("/control", Control_Command, self.controlcallback)

        self.writer_pos = self.node.create_writer("/geek/uwb/localization", pos)
	...
	self.yaw += self.velocity * (control.steer_angle * 2 * 3.14159265358979 / 180) * dt;
